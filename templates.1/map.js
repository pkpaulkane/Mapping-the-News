  ...
  for (var i=0; i<lat.length; i++) {
      ...
      var feature = new OpenLayers.Feature.Vector(
          ...
          {description: '<a href="' + url2 + '">Article Link</a>'},
          {externalGraphic: '/Users/Paul/Desktop/marker.png', graphicHeight: 25, graphicWidth: 21, graphicXOffset:-12, graphicYOffset:-25  }
      );             
